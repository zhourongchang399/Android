...
public class MsgAdapter extends RecyclerView.Adapter<MsgAdapter.ViewHolder> {
    ...
    public MsgAdapter(List<MessageInfo> msgList, Context context, UserInfo userInfo) {
        this.msgList = msgList;
        this.context = context;
        this.other_userInfo = userInfo;
    }
...
//                        holder.leftImage.setImageBitmap(ImageUtils.base64ToBitmap(other_userInfo.getImg()));
                    try {
...
//                        holder.otherImage.setImageBitmap(bitmap);
                        ...
                        Glide.with(context).load(new httpPathList().getUrl() + "/" + other_userInfo.getImg()).centerCrop().into(holder.leftImage);
//                        holder.leftImage.setImageBitmap(ImageUtils.base64ToBitmap(other_userInfo.getImg()));
                        holder.otherImage.setOnClickListener(new onClick(base64, position));
                    }
                }
            }
        }
