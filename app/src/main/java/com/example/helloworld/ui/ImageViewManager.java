...
public class ImageViewManager extends AppCompatImageView {
    float width,height;
    ...
    public ImageViewManager(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        init(context, attrs);
    }

    public ImageViewManager(Context context, AttributeSet attrs, int defStyleAttr) {
